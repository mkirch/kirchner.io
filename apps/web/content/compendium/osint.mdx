---
title: OSINT
description: Open Source Intelligence (OSINT) is the collection and analysis of information that is gathered from public or open sources.
icon: 'eye'
---

# OSINT

First try [OSINT Framework](https://osintframework.com/) for a nice tree of tools. 
